    ...
    <div className="py-8">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Second col */}
          <div
            className="py-10 pl-5 bg-gradient-to-br from-brandGreen/90 to-brandGreen/90 text-white 
          ...
          {/* Third Col */}
          <div
            className="py-10 pl-5 bg-gradient-to-br from-brandBlue to-brandBlue/90 text-white 
            rounded-3xl relative h-[320px] flex items-start"
          >
            <div>
              <div className="mb-4">
